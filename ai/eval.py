...
class EvalThread(Thread):
    ...
    def run(self):
        ...
        # Evaluate strictly at 60 FPS. If pulled faster than the monitor Hz, DXCam returns duplicate 
        # frames, destroying the neural net's calculation of velocity across the 10-frame buffer.
        ...
        try:
            ...
            while True:
                ...
                # cv2.INTER_AREA is absolutely REQUIRED here, even if it costs 5ms CPU time.
                # INTER_LINEAR deletes thin approach circles during downscaling, rendering the AI blind!
